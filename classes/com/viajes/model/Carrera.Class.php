...
class Carrera {
	...
	private static $itemsCONICET = array(
		...
		Carrera::Profesional_Asistente_CONICET=> CYT_LBL_SOLICITUD_CARRERA_PROFECIONAL_ASISTENTE_CONICET,
		Carrera::Profesional_Adjunto_CONICET=> CYT_LBL_SOLICITUD_CARRERA_PROFECIONAL_ADJUNTO_CONICET,
		Carrera::Profesional_Principal_CONICET=> CYT_LBL_SOLICITUD_CARRERA_PROFECIONAL_PRINCIPAL_CONICET,
	...
	private static $itemsCIC = array(
		...
		Carrera::Profesional_Asistente_CIC=> CYT_LBL_SOLICITUD_CARRERA_PROFECIONAL_ASISTENTE_CIC,
		Carrera::Profesional_Adjunto_CIC=> CYT_LBL_SOLICITUD_CARRERA_PROFECIONAL_ADJUNTO_CIC,
		Carrera::Profesional_Principal_CIC=> CYT_LBL_SOLICITUD_CARRERA_PROFECIONAL_PRINCIPAL_CIC,
	);
